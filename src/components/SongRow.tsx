  ...
  return (
    <>
      <div className="relative h-full overflow-hidden">
        ...
        {/* Main row */}
        <div
          className={`group relative flex items-center ${s.gap} px-3 h-full cursor-pointer transition-colors ${
        ...
        >
          ...
          <div className="w-6 flex items-center justify-center shrink-0">
            {selectionMode ? (
              ...
              <>
                <span className="text-xs tabular-nums text-fg/30 group-hover:hidden"
